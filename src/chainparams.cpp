...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.BIP34Height = 1500002;                      // <-- Einsteinium: finally enforced
        consensus.BIP34Hash = uint256S("2db2c2ce699df2d3a6b873efea89d9a73d1c0deb6aef39b401d02d5058ef1233"); // <-- Einsteinium: finally enforced
        consensus.BIP65Height = 1500002; // 2db2c2ce699df2d3a6b873efea89d9a73d1c0deb6aef39b401d02d5058ef1233
        consensus.BIP66Height = 1500002; // 2db2c2ce699df2d3a6b873efea89d9a73d1c0deb6aef39b401d02d5058ef1233
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Height = 1; // BIP34 activated on testnet after init
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 1; // BIP65 activated on testnet after init
        consensus.BIP66Height = 1; // BIP66 activated on testnet after init
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff");
