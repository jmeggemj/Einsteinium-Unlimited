...
UniValue getblocktemplate(const JSONRPCRequest& request)
{
    ...
    result.push_back(Pair("coinbasevalue", (int64_t)BLOCK_REWARD; //<--Einsteinium: Specifications
    result.push_back(Pair("charityvalue", (int64_t)CHARITY_AMOUNT; //<--Einsteinium: Specifications
