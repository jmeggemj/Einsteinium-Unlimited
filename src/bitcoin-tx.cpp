...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s einsteinium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  einsteinium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded einsteinium transaction") + "\n" +
              "  einsteinium-tx [options] -create [commands]   " + _("Create hex-encoded einsteinium transaction") + "\n" +
              "\n";
