...
VERSION=
commit=false
url=https://github.com/hashunlimited/einsteinium-unlimited
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the einsteinium, gitian-builder, gitian.sigs.ltc, and einsteinium-detached-sigs.
...
-u|--url	Specify the URL of the repository. Default is https://github.com/hashunlimited/einsteinium-unlimited
